  ...
  return (
    ...
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-6 lg:px-10">
        ...
        <Link
          to="/contact"
          className="group hidden items-center gap-2 rounded-full bg-foreground px-5 py-2 text-sm font-medium text-background transition-all hover:bg-primary md:inline-flex"
        >
          Book consultation
      ...
      {open && (
        <div className="fixed inset-x-0 top-16 z-40 animate-[fade-in_0.2s_ease-out] border-t border-border bg-background md:hidden">
          <nav className="container mx-auto flex flex-col px-6 py-6">
            ...
            <Link
              to="/contact"
              className="mt-6 inline-flex items-center justify-center gap-2 rounded-full bg-foreground px-5 py-3 text-sm font-medium text-background"
              onClick={() => setOpen(false)}
            >
              Book consultation
